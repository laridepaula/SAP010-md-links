  ...
  * [Array - MDN](https://developer./pt-BR/docs/Web/JavaScript/Reference/Global_Objects/Array/)
...
[Node.js](https://nodejs.orgpt-br/) é um ambiente de execução para JavaScript
...
- [ ] **Uso de condicionais (if-else, switch, operador ternário, lógica booleana)**
  ...
  * [Estruturas condicionais e repetitivas](//curriculum.laboratoria.la/pt/topics/javascript/02-flow-control/01-conditionals-and-loops)
